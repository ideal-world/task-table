...
const events = {
  ...
  saveCellDictItem: async (columnName: string, changedItem: TableCellDictValueItem) => {
    return new Promise((resolve) => {
      setTimeout(() => {
        resolve(true)
      }, 100)
...
const data3 = [
  { no: 10, name: 'xy', stats: ['init'], phone: 'Phone10', addr: 'Addr10', time: '2023-11-1' },
  { no: 11, name: 'xy', stats: ['init'], phone: 'Phone11', addr: 'Addr11', time: '2023-11-2' },
  { no: 12, name: 'xy', stats: ['init'], phone: 'Phone12', addr: 'Addr12', time: '2023-11-3' },
  { no: 13, name: 'xy', stats: ['init'], phone: 'Phone13', addr: 'Addr13', time: '2023-11-4' },
  { no: 14, name: 'xy', stats: ['init'], phone: 'Phone14', addr: 'Addr14', time: '2023-11-5' },
  { no: 15, name: 'xy', stats: ['init'], phone: 'Phone15', addr: 'Addr15', time: '2023-11-6' },
  { no: 16, name: 'xy', stats: ['init'], phone: 'Phone16', addr: 'Addr16', time: '2023-11-7' },
  { no: 17, name: 'xy', stats: ['init'], phone: 'Phone17', addr: 'Addr17', time: '2023-11-8' },
  { no: 18, name: 'xy', stats: ['init'], phone: 'Phone18', addr: 'Addr18', time: '2023-11-9' },
  { no: 19, name: 'xy', stats: ['init'], phone: 'Phone19', addr: 'Addr19', time: '2023-11-10' },
  { no: 20, name: 'xy', stats: ['init'], phone: 'Phone20', addr: 'Addr20', time: '2023-11-11' },
  { no: 21, name: 'xy', stats: ['finish'], phone: 'Phone21', addr: 'Addr21', time: '2023-11-12' },
  { no: 22, name: 'xy', stats: ['finish'], phone: 'Phone22', addr: 'Addr22', time: '2023-11-13' },
  { no: 23, name: 'xy', stats: ['finish'], phone: 'Phone23', addr: 'Addr23', time: '2023-11-14' },
  { no: 24, name: 'xy', stats: ['finish'], phone: 'Phone24', addr: 'Addr24', time: '2023-11-15' },
  { no: 25, name: 'xy', stats: ['finish'], phone: 'Phone25', addr: 'Addr25', time: '2023-11-16' },
  { no: 26, name: 'xy', stats: ['finish'], phone: 'Phone26', addr: 'Addr26', time: '2023-11-17' },
  { no: 27, name: 'xy', stats: ['finish'], phone: 'Phone27', addr: 'Addr27', time: '2023-11-18' },
  { no: 28, name: 'xy', stats: ['finish'], phone: 'Phone28', addr: 'Addr28', time: '2023-11-19' },
  { no: 29, name: 'xy', stats: ['finish'], phone: 'Phone29', addr: 'Addr29', time: '2023-11-20' },
]

const data4 = [
  { no: 18, name: 'xc', stats: ['finish'], phone: 'Phone18', addr: 'Addr18', time: '2023-11-9' },
  { no: 19, name: 'xc', stats: ['finish'], phone: 'Phone19', addr: 'Addr19', time: '2023-11-10' },
  { no: 20, name: 'xc', stats: ['finish'], phone: 'Phone20', addr: 'Addr20', time: '2023-11-11' },
  { no: 21, name: 'xc', stats: ['finish'], phone: 'Phone21', addr: 'Addr21', time: '2023-11-12' },
  { no: 22, name: 'xc', stats: ['finish'], phone: 'Phone22', addr: 'Addr22', time: '2023-11-13' },
  { no: 23, name: 'xc', stats: ['finish'], phone: 'Phone23', addr: 'Addr23', time: '2023-11-14' },
  { no: 24, name: 'xc', stats: ['finish'], phone: 'Phone24', addr: 'Addr24', time: '2023-11-15' },
  { no: 25, name: 'xc', stats: ['init'], phone: 'Phone25', addr: 'Addr25', time: '2023-11-16' },
  { no: 26, name: 'xc', stats: ['init'], phone: 'Phone26', addr: 'Addr26', time: '2023-11-17' },
  { no: 27, name: 'xc', stats: ['init'], phone: 'Phone27', addr: 'Addr27', time: '2023-11-18' },
  { no: 28, name: 'xc', stats: ['init'], phone: 'Phone28', addr: 'Addr28', time: '2023-11-19' },
