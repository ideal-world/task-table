...
export const FN_MODIFY_STYLES = 'modifyStyles'
export const FN_NEW_COLUMN = 'newColumn'
export const FN_MODIFY_COLUMN = 'modifyColumn'
export const FN_DELETE_COLUMN = 'deleteColumn'
export const FN_NEW_LAYOUT = 'newLayout'
export const FN_MODIFY_LAYOUT = 'modifyLayout'
export const FN_DELETE_LAYOUT = 'deleteLayout'
export const FN_SORT_LAYOUTS = 'sortLayouts'


export const FN_CLOSE_CONTEXT_MENU = 'closeContextMenu'